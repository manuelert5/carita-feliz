...
<%
    procesos dat = new procesos();
    ArrayList<departamento> depto = new ArrayList();

    try {
        dat.crea_conexion();
        ResultSet rst = dat.llama_funcion("retorna_deptos", "");
        while (rst.next()) {
            depto.add(new departamento(rst.getInt("id_departamento"),
                    rst.getString("departamento")));
        }
...
<html>
    <head>
        ...
        <script src="js/seleccionDeptoYMuniciopio.js"></script>
            ...
            $(document).ready(function () {
                ...
                $("#formulario").submit(function (e) {
                    ...
                    var data = {
                        ...
                        "Text_municipio":       $("#option_municipio option:selected").val(),
                        "select_depto":         $("#option_depto option:selected").val(),
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response == "0")
                            {
                                ...
                                $("#contenedorExito").html("Se creo el registo con exito");
                            } 
            ...
            <form class="form-horizontal" id="formulario" role="form" >
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select class="selectpicker form-control" id="option_depto"  required data-live-search="true" data-size="5" required>
                                <option></option>
                                <%                                                        for (int i = 0; i < depto.size(); i++) {
                                        out.print("<option value='" + depto.get(i).getId() + "'>" + depto.get(i).getDepartamento() + "</option>");
                                    }
                                %>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="selectbasic">Municipio<font color="FF9100">*</font></label>
                        <div class="col-md-4">
                            <select class="selectpicker form-control" id="option_municipio"  required data-live-search="true" data-size="5" required>
                                <option></option>
                    ...
                    <%
                        ...
                        } else if (rol == 0)//si viene de un ususario administrador
                        {
                            ...
                            out.print("	              <label class='col-md-4 control-label' for='address1'>Número de Socio</label>  	");
                            out.print("	              <div class='col-md-4'>	");
                            out.print("	              <input id='Text_socio' name='address1' type='text'  placeholder='Ingrese el numero de Socio al que estara asociado' class='form-control input-md'  pattern='^[0-9]*'>	");
                            out.print("	              </div>	");
                            out.print("	            </div>      	");
