...
//        $("#contenedor_carrito").hide();
                    ...
                    success: function (response) {
                        ...
                        for (i = 0; i < obj.length; i++) {
                            ...
                            $("tbody").prepend("<tr>" +
                                    ...
                                    "<a href='#' onclick='eliminaElementoCarrito(" + obj[i].id_carrito + ");'>" +
            ...
            function eliminaElementoCarrito(idCarrito){
            ...
            function agergarCarritOfer(idUser, idProducto) {
                idUserGlobal = idUser;
                idProdcutoGlobal = idProducto;
                $("#modalOfetas").modal("hide");
    ...
    <body>
        ...
        <button type="button" class="ir-arriba btn btn-info btn-circle btn-xl" onclick="siguiente();" style="z-index: 2;"><i class="glyphicon glyphicon-chevron-right"></i></button>



        <div class="container" style="z-index: 1;" ><!--esta es la barra de progreso-->
            <div class="row">
                <ul class="breadcrumb">
        ...
        <jsp:include page="ofertas.jsp" flush="true"/>
